...
<head>
    ...
    <title>{{ $page }} Page | System Application SPA</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h2 text-gray-900 mb-3">Create New Account, Please Fill Form Data
                                            Correctly!
                                        </h1>
                                    ...
                                    <form class="user" action="{{ route('register.action') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-user"
                                                placeholder="Enter Number Phone..." name="number_phone">
                                        </div>
                                        <div class="form-group">
